...
-- Config
local CONFIG = {
    TargetPlaceId = 126884695634066, -- Ganti sesuai kebutuhan
    MaxPlaceVersion = 1273
}

-- Cegah GUI muncul ulang setelah teleport
...
-- GUI hanya muncul sekali saja
if not _G.guiConfigured then
    _G.guiConfigured = true
...
-- Sisanya lanjut seperti biasa (check Blood Moon, hop, dsb)
-- ... (lanjutkan dengan logikamu dari script sebelumnya)